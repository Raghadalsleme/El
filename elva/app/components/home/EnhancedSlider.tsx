        ...
        <div slot="items">
          {slides.map((slide, index) => (
            ...
            >
              ...
              <div className="flex-center container pb-16 sm:pb-0 home-slider__content relative h-full elva-hero-wrap">

                <div className="w-4/6 text-right md:w-7/12 lg:w-6/12 text-white elva-hero-text">

                  {slide.title && (
                    <h2
                      data-swiper-parallax="-500"
                      className="lg:text-title-size font-bold leading-tight mb-4 elva-hero-title"
